...
function Index() {
  ...
  let [lodear,Setlodear]=useState(false);
        ...
        return (
          <React.Fragment key={user._id}>
            <tr>
              ...
              <td>{user.email} </td>
              <td>{user.password}</td>
              <td className='bg-danger text-white' onClick={()=>deleteUser(user._id)}> Delete </td>
              <td className='bg-warning text-white'><Link to={`/user/${user._id}`}> Details </Link> </td>
              <td className='bg-success text-white'  onClick={()=>deleteUser(user._id)}> 
